...
wire [3:0] key_buffer_ms_hr, key_buffer_ms_min, key_buffer_ls_hr, key_buffer_ls_min, current_time_ms_hr,current_time_ls_hr,current_time_ms_min,current_time_ls_min,alarm_time_ms_hr,alarm_time_ms_min,alarm_time_ls_hr,alarm_time_ls_min;

//instatantiate all the module
...
counter count1 (.one_minute(one_minute),
                ...
                .new_current_time_ls_hr(key_buffer_ms_hr),
...
lcd_driver_4 lcd_disp(.alarm_time_ms_hr(alarm_time_ms_hr),
                      ...
                      .current_time_ms_min(current_time_ms_min),
                      .current_time_ls_min(current_time_ls_min),
                      .key_ms_hr(key_buffr_ms_hr),
                      .key_ls_hr(key_buffr_ls_hr),
                      .key_ms_min(key_buffr_ms_min),
                      .key_ls_min(key_buffr_ls_min),
                      .show_a(show_a),
